...
Original file is located at
    https://colab.research.google.com/drive/1pq9swZGHKfOqhWqtZzFYsHIGmi-sv_7F
...
Here, we train the decision tree regression Model on the whole dataset. First, we import the RandomForestRegressor from the Scikit-learn libary. Next, we use the fit method to train the model on the dataset.
"""
